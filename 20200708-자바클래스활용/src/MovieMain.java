...
public class MovieMain extends JFrame implements ActionListener {
	...
	MovieMain(){ //생성자 : 클래스명과 동일, 리턴형x
		...
		try {
			URL url=new URL("http://img.cgv.co.kr/Movie/Thumbnail/Poster/000083/83343/83343_1000.jpg");
	...
	{
		pan.setLayout(new GridLayout(4,5,8,8)); //4개씩 5줄 위아래 간격 8씩 띄운다
